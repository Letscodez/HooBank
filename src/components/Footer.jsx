...
const Footer = () => (
    ...
    <section id='about' className={`${styles.flexCenter} ${styles.paddingY} flex-col`}>
      ...
      <div className="w-full flex justify-between items-center md:flex-row flex-col border-t border-t-[#3f3e45] pt-6">
        <p className='font-poppins font-normal text-center text-[18px] leading-[27px] text-white'>
          <span className='text-[18px] leading-[27px] font-normal text-center'>Copyright © </span>
